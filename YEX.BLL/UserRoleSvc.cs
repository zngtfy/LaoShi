...
namespace YEX.BLL
{
    ...
    /// UserRole service
    /// </summary>
    public class UserRoleSvc : GenericSvc<UserRoleRep, UserRole>
    {
        #region -- Overrides --
        ...
        public override SingleRsp Create(UserRole m)
        {
        ...
        /// <returns>Return the result</returns>
        public override MultipleRsp Create(List<UserRole> l)
        {
            var res = new MultipleRsp();
            var lErr = new List<UserRoleDto>();
            var lOki = new List<UserRole>();
            ...
            if (lOki.Count > 0)
            {
                ...
                res.SetSuccess(UserRoleDto.ToDto(lOki), string.Empty);
            }
        ...
        /// <param name="m">The model</param>
        /// <returns>Return the result</returns>
        public override SingleRsp Update(UserRole m)
        {
            var res = new SingleRsp();
        ...
        /// <param name="l">List model</param>
        /// <returns>Return the result</returns>
        public override MultipleRsp Update(List<UserRole> l)
        {
            var res = new MultipleRsp();
            var lErr = new List<UserRoleDto>();
            var lOki = new List<UserRole>();
